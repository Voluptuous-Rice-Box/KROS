...
iso:
	...
	g++ -m32 -c src/io/terminal.cpp -o terminal.o -ffreestanding -fno-exceptions -fno-rtti
	...
	gcc -m32 io_port.o bootloader.o kernel.o terminal.o -T src/linker.ld -o iso/boot/kern -nostdlib -nodefaultlibs -lgcc
